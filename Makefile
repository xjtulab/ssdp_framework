...
objects = src/SSDP_LOG.o src/SSDP_API.o src/commandprocess.o src/SSDPServer.o src/DeviceDSP.o src/DeviceFPGA.o src/DspPublisher.o src/HelloWorld.o src/DeviceZED.o
